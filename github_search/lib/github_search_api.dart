...
class SearchResult {
  ...
  bool get isPopulated => this.kind == SearchResultKind.populated;
  bool get isEmpty => this.kind == SearchResultKind.empty;
  bool get isNoTerm => this.kind == SearchResultKind.noTerm;
}
